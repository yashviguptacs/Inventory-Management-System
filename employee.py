...
class employeeClass:
    def __init__(self,root):
        ...
        # *****Title******
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#4f4d7d",fg="white").place(x=50,y=100,width=1000)
        ...
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="lightyellow").place(x=50,y=190)
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15),bg="lightyellow").place(x=350,y=190)
        lbl_doj=Label(self.root,text="D.O.J",font=("goudy old style",15),bg="lightyellow").place(x=750,y=190)
        ...
        lbl_email=Label(self.root,text="Email",font=("goudy old style",15),bg="lightyellow").place(x=50,y=230)
        lbl_pass=Label(self.root,text="Password",font=("goudy old style",15),bg="lightyellow").place(x=350,y=230)
        lbl_utype=Label(self.root,text="User Type",font=("goudy old style",15),bg="lightyellow").place(x=750,y=230)
        ...
        lbl_address=Label(self.root,text="Address",font=("goudy old style",15),bg="lightyellow").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="lightyellow").place(x=500,y=270)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This Employee ID already used, try different Employee ID",parent=self.root)
                else:

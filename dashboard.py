...
class IMS:
    def __init__(self,root):
        ...
        # ****title****
        self.icon_title=PhotoImage(file="images/Achievements.png")
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#171717",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        
        # **** Logout Button****
        btn_logout=Button(self.root,text="Logout",font=("times new roman", 15 ,"bold"),bg="red",cursor="hand2").place(x=1150,y=10,height=30,width=150)
        # ****clock*****
        self.lbl_clock=Label(self.root,text="Welcome to Inventory Management System\t\t Date:DD-MM-YY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#3EC1D3",fg="white")
        self.lbl_clock.place(x=0,y=70,relwidth=1,height=30)

        # ****Left Menu****
        self.MenuLogo=Image.open("images/achievements.png")
        ...
        # self.icon_side=PhotoImage(file="images/Achievements.png")

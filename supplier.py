...
class supplierClass:
    def __init__(self,root):
        ...
        # *****Title******
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="#4f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)
        ...
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="lightyellow").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=120,width=180)
        
        ########row3###############

        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="lightyellow").place(x=50,y=160)
        ...
        lbl_desc=Label(self.root,text="Description",font=("goudy old style",15),bg="lightyellow").place(x=50,y=200)
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Invoice no. already used, try different",parent=self.root)
                else:
